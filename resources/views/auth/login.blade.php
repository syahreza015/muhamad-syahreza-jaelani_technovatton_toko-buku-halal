...
<head>
  ...
  <title>Toko Buku Halal</title>
  <link rel="icon" href="{{asset("assets/dist/img/logo-fesyar.png")}}">
...
<div class="login-box">
  <div class="login-logo">
      <img src="{{ asset('assets/dist/img/logo-isef.png') }}" width="240px" height="128px" ><br>
    <a  style="color: black;font-size:30px;"><b>Aplikasi Toko Buku Halal</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <div class="mb-3 text-center social-auth-links">
        ...
        <button type="submit" class="btn btn-block btn-primary">
                <i class="mr-2 fa fa-sign-in"></i> Masuk
        </button>

        @if (Route::has('password.request'))
        <a href="{{ route('password.request') }}" class="btn btn-block btn-danger">
          <i class="mr-2 fa fa-lock"></i> Lupa Password
        </a>
        @endif
